...
set_location_assignment PIN_J15 -to arsn_i
set_location_assignment PIN_A15 -to full_o

set_location_assignment PIN_D3 -to trace_push_i
set_location_assignment PIN_C3 -to trace_sel_i[0]
set_location_assignment PIN_A3 -to trace_sel_i[1]
set_location_assignment PIN_B4 -to trace_break_i
set_location_assignment PIN_B5 -to trace_update_i

set_location_assignment PIN_D5 -to trace_id_push_i
set_location_assignment PIN_A6 -to trace_id_value_i[0]
set_location_assignment PIN_D6 -to trace_id_value_i[1]
set_location_assignment PIN_C6 -to trace_id_value_i[2]
set_location_assignment PIN_E6 -to trace_id_value_i[3]
set_location_assignment PIN_D8 -to trace_id_value_i[4]
set_location_assignment PIN_F8 -to trace_id_value_i[5]

set_location_assignment PIN_R14 -to commit_id_pull_i
set_location_assignment PIN_P15 -to commit_id_valid_o
set_location_assignment PIN_R16 -to commit_id_value_o[0]
set_location_assignment PIN_L16 -to commit_id_value_o[1]
set_location_assignment PIN_N9 -to commit_id_value_o[2]
set_location_assignment PIN_N12 -to commit_id_value_o[3]
set_location_assignment PIN_P11 -to commit_id_value_o[4]
set_location_assignment PIN_T10 -to commit_id_value_o[5]

set_location_assignment PIN_A5 -to queues_status_push_i[0]
set_location_assignment PIN_B6 -to queues_status_push_i[1]
set_location_assignment PIN_B7 -to queues_status_push_i[2]
set_location_assignment PIN_A7 -to queues_status_push_i[3]

set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to clk_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to arsn_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to full_o

set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_push_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_sel_i[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_sel_i[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_break_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_update_i

set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_id_push_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_id_value_i[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_id_value_i[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_id_value_i[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_id_value_i[3]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_id_value_i[4]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to trace_id_value_i[5]


set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to commit_id_pull_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to commit_id_valid_o
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to commit_id_value_o[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to commit_id_value_o[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to commit_id_value_o[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to commit_id_value_o[3]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to commit_id_value_o[4]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to commit_id_value_o[5]

set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to queues_status_push_i[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to queues_status_push_i[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to queues_status_push_i[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to queues_status_push_i[3]
